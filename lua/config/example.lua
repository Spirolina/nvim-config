...
return {
...

  {
    ...
    opts = {
      ...
      servers = {
        ...
        tsserver = {
          ...
          on_attach = function(client, bufnr)
            -- Disable tsserver's formatting if you're using a separate formatter
      ...
      on_attach = function(client, bufnr)
        -- Define keymaps and other settings for LSP features
        ...
        -- Additional configuration based on the server
